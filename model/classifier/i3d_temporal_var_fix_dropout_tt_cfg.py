...
def temporal_only_conv(module, name, removed, stride_removed=0):
    ...
    for attr_str in dir(module):
        ...
        if type(sub_module) == nn.Conv3d:
            ...
            # Newer PyTorch exposes extra Conv3d signature args like device/dtype
            # that are constructor-only and not stored as module attributes.
            param_dict = {
                key: getattr(sub_module, key) for key in parameters if hasattr(sub_module, key)
            }
