...
def _build_resnet50(pretrain):
    """Create resnet50 with torchvision>=0.13 weights API and old-version fallback."""
    import torchvision.models as models

    try:
        weights = models.ResNet50_Weights.DEFAULT if pretrain else None
        return models.resnet50(weights=weights)
    except AttributeError:
        return models.resnet50(pretrained=pretrain)
...
class RetinaFace(nn.Module):
    def __init__(self, cfg=None, phase="train"):
        ...
        if cfg["name"] == "mobilenet0.25":
            ...
            backbone = _build_resnet50(cfg["pretrain"])
